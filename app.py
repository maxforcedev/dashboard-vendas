                ...
                dbc.CardBody([
                    dbc.Row([
                        ...
                        dbc.Col([
                            ...
                            href="https://www.linkedin.com/in/maxforcedev",  #
                            target="_blank")
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    dbc.Row(
                        dbc.Col(
                            html.Legend('Melhores vendedores por equipe')
                        )
                    ),
                    dbc.Row([
                        dbc.Col([
...
def graph5(month, toggle):
    ...
    fig5.add_trace(go.Indicator(mode='number+delta',
        title = {"text": f"<br><span>{df_5['Consultor'].iloc[0]}<br>Vendedora do mês</span><br><span style='font-size:70%'>Em vendas - em relação a média</span><br>"},
    ...
    fig6.add_trace(go.Indicator(mode='number+delta',
        title = {"text": f"<span>{df_6['Equipe'].iloc[0]}<br>Equipe do mês</span><br><span style='font-size:70%'>Em vendas - em relação a média</span><br>"},
    ...
    fig5.update_layout({"margin": {"l":0, "r":0, "t":60, "b":0}})
    fig6.update_layout({"margin": {"l":0, "r":0, "t":60, "b":0}})
    return fig5, fig6
